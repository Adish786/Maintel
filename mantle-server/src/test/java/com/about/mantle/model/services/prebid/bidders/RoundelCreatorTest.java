...
public class RoundelCreatorTest {

	private static RoundelCreator roundel = new RoundelCreator();
	private PrebidCsvLine prebidCsvLine;

	@Before
	public void resetLine() {
		prebidCsvLine = new PrebidCsvLine();
		prebidCsvLine.setBidder("Roundel");
		prebidCsvLine.setAccountId("382319");
	}
	...
	public void testCreate() {
		Bidder bidder = roundel.create(prebidCsvLine);
		assertEquals("roundel", bidder.getCode());
	...
	public void testValidate() {
		try {
			roundel.validate(prebidCsvLine);
		} catch (Exception e) {
