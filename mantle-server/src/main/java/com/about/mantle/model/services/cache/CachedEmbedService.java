...
public class CachedEmbedService implements EmbedService {

	private static final Logger logger = LoggerFactory.getLogger(CachedEmbedService.class);

	private final EmbedService service;
	private final CacheTemplate<EmbedContent> cache;

	public CachedEmbedService(EmbedService service, CacheTemplate<EmbedContent> cache) {
	...
	public EmbedContent getContent(String url, Map<String, Map<String, String>> options) {
		CacheKey key = new CacheKey(url, options);
