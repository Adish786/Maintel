...
/*
With OneTrust SSR implementation the eventCategory for banners will be changed to '#onetrust-consent-sdk' so
created this test to accommodate the changes.
During the OT ssr rollout to a vertical, the tests on the vertical will be updated to reference these new tests.
 */
@Deprecated
public class MntlBannersSSRClickTrackingTest extends MntlClickTrackingTest {
